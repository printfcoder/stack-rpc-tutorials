...
func (c *service) PayOrder(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Service.PayOrder", in)
	out := new(Response)
...
func (h *serviceHandler) PayOrder(ctx context.Context, in *Request, out *Response) error {
	return h.ServiceHandler.PayOrder(ctx, in, out)
}
