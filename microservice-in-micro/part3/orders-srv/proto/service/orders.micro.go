...
func (c *service) New(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Service.New", in)
	out := new(Response)
...
func (h *serviceHandler) New(ctx context.Context, in *Request, out *Response) error {
	return h.ServiceHandler.New(ctx, in, out)
}
